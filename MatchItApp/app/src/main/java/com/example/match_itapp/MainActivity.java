...
public class MainActivity extends AppCompatActivity {
    ...
    //Array for images
    Integer [] cardsArray={101, 102, 103, 104, 105, 106,107,108,109,110,201,202,203,204,
            205,206,207,208,209,210};

    //actual images
    int image101, image102, image103, image104, image105, image106,image107,image108,
            image109, image110,image201,image202,image203,image204,image205,image206,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //changing color of second player(inactive)
    ...
    private void doStuff(ImageView iv, int card) {
        ...
        //check which image is selected & saving it to temp variable
        if(cardNumber == 1){
